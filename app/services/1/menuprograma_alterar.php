...
if (isset($jsonEntrada['idMenuPrograma'])) {
    ...
    $sql = "UPDATE menuprograma SET IDMenu = $IDMenu, progrNome ='$progrNome', idAplicativo ='$idAplicativo', progrLink ='$progrLink', nivelMenu = $nivelMenu WHERE idMenuPrograma = $idMenuPrograma";
