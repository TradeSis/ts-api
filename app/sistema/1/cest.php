...
$where = " WHERE ";
if (isset($jsonEntrada["codigoCest"])) {
    $sql .= $where . " fiscest.codigoCest = " . $jsonEntrada["codigoCest"];
    $where = " AND ";
}
...
if (isset($jsonEntrada["nomeCest"])) {
    $sql .= $where . " fiscest.nomeCest LIKE '%" . $jsonEntrada["nomeCest"] . "%'";
    $where = " AND ";
}
