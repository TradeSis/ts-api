...
if (isset($jsonEntrada['nomeProduto'])) {
    ...
    $sql = "INSERT INTO catalogo (`nomeProduto`,`imgProduto`,`idMarca`,`precoProduto`,`ativoProduto`,`propagandaProduto`,`descricaoProduto`) VALUES ('$nomeProduto','$imgProduto','$idMarca','$precoProduto','$ativoProduto','$propagandaProduto','$descricaoProduto')";
